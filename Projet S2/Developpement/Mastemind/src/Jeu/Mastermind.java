...
import strategy.implementations.Simple2;
import Libs.Joueur;
import Libs.Couleur;
...
{	
	...
	public static void main(String[] args)
	{
		...
		System.out.println("+ - - - Choix des paramètres - - - +");
			...
			// On lui pr�sente les couleurs, il appuis sur une touche  pour choisir
		...
		BasicStrategy strategy= new Simple2(nb_pions);
		...
		for (int i = 0; i < nb_pions; i++)
		{
			...
			System.out.println("Appuyez sur le num�ro de la couleur que vous voulez choisir pour votre "+(i+1) + " pion ?");
			afficherCouleur();
		...
		System.out.println("Appuyez sur une touche pour dmarer la partie ...A");
		appuyerContinuer();
